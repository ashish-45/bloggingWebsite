...
<body style="background-color: lightgray;">
    ...
    <?php
            ...
            $sql =  "INSERT INTO `visitor`( `count`) VALUES (' ')";
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="margin: auto;">
                                <button type="button" id="googleSignIn" class="btn btn-outline-success"><i class="fab fa-google"></i>
                                    &nbsp;Signup With Gooogle</button>
                                <br><br>
                                <button type="button"  id="facebookSignIn" class="btn btn-outline-primary"> <i class="fab fa-facebook"></i>
                                    &nbsp;Signup With Facebook</button>
                            </div>
                            <p style="margin: auto;">Already Have an Account ? </p>
                            <div class="modal-body" style="margin: auto;">
                                <button type="button" onclick="googleSignin()" class="btn btn-outline-success"><i
                                        class="fab fa-google"></i>
                                    &nbsp;SignIn</button>
                                <br><br>
                                <button type="button" onclick=" FacebookSignin() " class="btn btn-outline-primary"> <i
        ...
        <div class="row">
            ...
            <div class="col-sm-4  mt-2">
                ...
                <div style="margin-top: 10px;">
                    ...
                    <p style="color:gray">A short Personal history of my favourite fast Food.
                    <a href="blogPage.php" style="text-decoration:none;color:black">(Read More....)</a>
